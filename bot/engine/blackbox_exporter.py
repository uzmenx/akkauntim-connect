...
_last_exported_hash: str = ""

def export_blackbox_json(db_path: str = "decisions_log.db", output_path: str = "public/blackbox.json", force: bool = False) -> None:
    """Black box ma'lumotlarini JSON faylga eksport qilish (fayl kontenti o'zgargandagina yozadi)."""
    ...
    try:
        ...
        # Kontent o'zgarishini tekshirish (hash orqali ortiqcha disk yozishlarini oldini olish)
        ...
        current_hash = hashlib.md5(content_payload.encode('utf-8')).hexdigest()
        if not force and current_hash == _last_exported_hash and os.path.exists(output_path):
            logger.debug("Black box statistikasi o'zgarmagan, disk yozish o'tkazib yuborildi.")
            return
        ...
        _last_exported_hash = current_hash
