...
class DecisionLogger:
    ...
    def init_schema(self):
        ...
        try:
            ...
            cursor.execute("CREATE INDEX IF NOT EXISTS idx_decisions_pair ON ai_decisions(pair)")
            cursor.execute("CREATE INDEX IF NOT EXISTS idx_decisions_ticket ON ai_decisions(ticket)")
            cursor.execute("CREATE INDEX IF NOT EXISTS idx_decisions_pair_id ON ai_decisions(pair, id DESC)")
            conn.commit()
